...
%Load image
% 读取原始图像
%originalImg = imread('C:\Users\amrian\Desktop\4695db27143b3909f5c2d41f8423767.jpg');

% 读取原始图像
originalImg = imread('..\Source_Code\3096.jpg');
...
% 调整图像分辨率
Img = imresize(originalImg, [newHeight newWidth]);
%Load the class.
%B=load('C:\Users\amrian\matlab函数程序\Bio-Inspired-Fossil-Image-Segmentation-for-Paleontology-main\CGFFCM-main\Test_Dataset\Ground_Truth\class134052.mat');
B=load('..\Test_Dataset\Ground_Truth\class3096.mat');
...
v(1,1:3) = 0.2;                 % Weight of group 1
v(1,4:6) = 0.4;                 % Weight of group 2
v(1,7:8) = 0.4;                 % Weight of group 3
G = [1 1 1 2 2 2 3 3];          % Feature Groups (three group 1, 2 and 3)
oo=0.01;                       % interval (0,1]
